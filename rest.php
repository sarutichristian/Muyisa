...
<body>
  ...
  <header>
    ...
    <ul class="navbar">
      ...
      <li><a href="login.php">NOUVELLE ARIVEE</a></li>
      <li><a href="login.php">PRODUITS</a></li>
      <li><a href="login.php">COMMENTAIRES</a></li>
    </ul>
  </header>
  ...
  <div class="container">
    ...
    <form method="post" action="">
      <div class="form-group">
        ...
        <label for="confim"> Confirmer </label>
        <input type="password" id="password" name="confirmpassword" placeholder="confirm password" required>
      </div>
      <button type="submit" name="send">Réinitialiser</button>

      <br>
      <button class="bx1">  <a href="login.php">Connectez-vous ici</a></button>
