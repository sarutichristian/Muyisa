...
<!-----search-->
    ...
    <div class="user">
      <div class="password-form">
        ...
        <button onclick="checkPassword()"> Change Account </button>
        <button><a href="pass.html">Log out</a></button>
    
        <p>Forgot Password? <a href="rest.html"> Reset Now</a></p>

        <p>Don't you have An account? <a href="log.html">Create Now</a></p>
    </div>
...
<label for="nam">NAME:</label>
        <input type="text" name="nam" placeholder="enter the name of product" required>
        <label for="pri">PRICE:</label>
        <input type="number" name="pri" id="" placeholder="Enter the price" required>
