...
<body>
    ...
    <section id="feedback-form" class="image-container">
        ...
        <form action="" method="post">
          <label for="name"><ii>customer_id</ii>:<?php  echo $row["id"]?></label><br>
          <label for="name"><ii>Name</ii>:<?php  echo $row["Name"]?></label><br>
          <label for="name"><ii>LastName</ii>:<?php  echo $row["lastName"]?></label><br>
