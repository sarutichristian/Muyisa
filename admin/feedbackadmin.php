...
<div class="main">
  ...
  <div class="image-container">
    <form action="process_feedback.php" method="post">
        <label for="name"><ii>User_id</ii>:<?php  echo $row["user_id"]?></label><br>
        <label for="name"><ii>Nom</ii>:<?php  echo $row["name"]?></label><br>
        <label for="email"><ii>Email</ii>: <?php  echo $row["email"]?></label><br>
        <label for="feedback"><ii>Feedback</ii>: <?php  echo $row["message"]?> </label>
        <label for="email"><ii>Date</ii>: <?php  echo $row["date"]?></label><br>
